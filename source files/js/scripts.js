...
/*Dropdown Menu*/
$('.lcoation.dropdown').click(function () {
    $(this).attr('tabindex', 1).focus();
    $(this).toggleClass('active');
    $(this).find('.dropdown-menu').slideToggle(300);
});
$('.lcoation.dropdown').focusout(function () {
    $(this).removeClass('active');
    $(this).find('.dropdown-menu').slideUp(300);
});
$('.lcoation.dropdown .dropdown-menu li').click(function () {
    $(this).parents('.lcoation.dropdown').find('span').text($(this).text());
    $(this).parents('.lcoation.dropdown').find('input').attr('value', $(this).attr('id'));
});
/*End Dropdown Menu*/
